            ...
            //-------------------------------------------------------------------------------------
                ...
                // Pixel Graph Evaluation
                    SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
                    {
                        ...
                        _PlanarNM_CC203AB1.AbsoluteWorldSpacePosition = IN.AbsoluteWorldSpacePosition;
                        _PlanarNM_CC203AB1.uv0 = IN.uv0;
                        float4 _PlanarNM_CC203AB1_XZ_2;
                        SG_PlanarNM_c0f081da9c567704ea36e7dd38cedcf6(TEXTURE2D_ARGS(_BaseColorMap, sampler_BaseColorMap), _BaseColorMap_TexelSize, _Property_3E4B16C8_Out_0, _Property_F2A4C04A_Out_0, _PlanarNM_CC203AB1, _PlanarNM_CC203AB1_XZ_2);
                        ...
                        float _Property_A53B65E3_Out_0 = _USEDYNAMICCOVERTSTATICMASKF;
                        ...
                        _PlanarNMn_26AF2BB7.AbsoluteWorldSpacePosition = IN.AbsoluteWorldSpacePosition;
                        _PlanarNMn_26AF2BB7.uv0 = IN.uv0;
                        float4 _PlanarNMn_26AF2BB7_XZ_2;
                        SG_PlanarNMn_1b93a87456f9d4c419321d0cd92bd6c8(TEXTURE2D_ARGS(_BaseNormalMap, sampler_BaseNormalMap), _BaseNormalMap_TexelSize, _Property_3E4B16C8_Out_0, _Property_F2A4C04A_Out_0, _PlanarNMn_26AF2BB7, _PlanarNMn_26AF2BB7_XZ_2);
                        ...
                        float3x3 Transform_924854E1_transposeTangent = transpose(float3x3(IN.WorldSpaceTangent, IN.WorldSpaceBiTangent, IN.WorldSpaceNormal));
                        float3 _Transform_924854E1_Out_1 = mul(Transform_924854E1_transposeTangent, _Lerp_A6AC44DC_Out_3.xyz).xyz;
                        ...
                        float _Clamp_10FE14DE_Out_3;
                        Unity_Clamp_float(_Multiply_17104BB2_Out_2, 0, 1, _Clamp_10FE14DE_Out_3);
                        float _Branch_361AADC3_Out_3;
                        Unity_Branch_float(_Property_A53B65E3_Out_0, _Clamp_10FE14DE_Out_3, _Clamp_8BDA8462_Out_3, _Branch_361AADC3_Out_3);
                        float3 _Lerp_75D9504F_Out_3;
                        Unity_Lerp_float3(_BlendOverlayBaseColor_DC11EFE2_OutVector4_1, (_Multiply_64C7F396_Out_2.xyz), (_Branch_361AADC3_Out_3.xxx), _Lerp_75D9504F_Out_3);
                        ...
                        Unity_Lerp_float3(_NormalBlend_24C86B99_Out_2, _NormalStrength_EE9C3A89_Out_2, (_Branch_361AADC3_Out_3.xxx), _Lerp_CC69B645_Out_3);
                        Bindings_PlanarNM_c0f081da9c567704ea36e7dd38cedcf6 _PlanarNM_5310F6E5;
                        _PlanarNM_5310F6E5.AbsoluteWorldSpacePosition = IN.AbsoluteWorldSpacePosition;
                        _PlanarNM_5310F6E5.uv0 = IN.uv0;
                        float4 _PlanarNM_5310F6E5_XZ_2;
                        SG_PlanarNM_c0f081da9c567704ea36e7dd38cedcf6(TEXTURE2D_ARGS(_BaseMaskMap, sampler_BaseMaskMap), _BaseMaskMap_TexelSize, _Property_3E4B16C8_Out_0, _Property_F2A4C04A_Out_0, _PlanarNM_5310F6E5, _PlanarNM_5310F6E5_XZ_2);
                        ...
                        Unity_Lerp_float3(_Vector3_FEF1FB88_Out_0, _Vector3_4B858D29_Out_0, (_Branch_361AADC3_Out_3.xxx), _Lerp_6B5C6348_Out_3);
