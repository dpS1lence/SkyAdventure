            ...
            //-------------------------------------------------------------------------------------
                ...
                // Vertex Graph Evaluation
                    VertexDescription VertexDescriptionFunction(VertexDescriptionInputs IN)
                    {
                        ...
                        CalculateWind_float(IN.ObjectSpacePosition, IN.ObjectSpaceNormal, IN.TimeParameters.x, _CustomFunction_B2A88CC6_vertex_3, _CustomFunction_B2A88CC6_normal_4);
